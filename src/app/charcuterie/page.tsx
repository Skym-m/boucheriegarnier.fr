        ...
        <>
            <section id="charcuterie">
                <div className="charcuterie">
                    ...
                    <h4>Notre charcuterie est travaillée, affinée et séchée dans nos locaux avec des recettes
                        traditionnelles
                    </h4>
                    ...
                    <h4>
                        Vous trouverez de nombreux produits : saucisson, saucisse sèche, caillette, jambon cuit nature
                        ou aux herbes, jambon cru, viande séchée, pâté en croute…
                    </h4>
