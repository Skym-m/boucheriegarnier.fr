        ...
        <>
            <section id="creations">
                <div className="creations">
                    ...
                    <h2>Nos créations</h2>
                    <h4>L&apos;équipe de la Maison GARNIER a toujours de bonnes idées et vous propose des créations
                        diverses et variées pour répondre à vos attentes.<br/>
                    ...
                    <div className="image-grid">
                        ...
                        <img src="/creations/burgers.jpg" alt="Burgers" className="wide"/>
