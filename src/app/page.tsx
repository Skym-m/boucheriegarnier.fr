        ...
        <>
            ...
            <section id="about">
                <div className="about">
                    ...
                    <h2>Bienvenue</h2>
                    <h4>
                        La Maison GARNIER située à proximité du centre-ville de Montélimar et au sein d’un espace
                        commercial est heureuse de vous accueillir du Mardi au Samedi de 6h30 à 19h.<br/>
                        Un parking est à votre disposition devant le magasin.<br/>
                        Une équipe souriante, dynamique et compétente vous proposera des produits pour toutes vos envies
                        : bœuf, veau, agneau, porc, charcuterie et tant d’autres, des produits de qualité avec une
                        origine contrôlée.
                    </h4>
                </div>
            ...
            <section id='history'>
                <div className='history'>
                    ...
                    <h4>
                        La boucherie GARNIER existe depuis 1930. Elle s’appelait alors &quot;Au sacrifice&quot; et se
                        trouvait au centre-ville.<br/>
                        En 1964, Ida et Marcel GARNIER reprennent le magasin, changent le nom puis le transmettent à
                        leur fils Gérard en 1992.<br/>
                        <br/>Des années plus tard, le magasin se déplace non loin de là, Avenue St Lazare pour être plus
                        facilement accessible.
                        Gérard GARNIER, doué d’une capacité relationnelle innée se consacre toute sa vie à sa
                        boutique.<br/>
                        Proche de la retraite, il choisit lui-même son successeur et décide de transmettre son œuvre à
                        un de ses anciens apprentis, Thierry VEYRENCHE.<br/>
                        <br/>Et c’est ainsi que celui-ci acquiert en 2020 un second magasin après celui du Teil.<br/>
                        Tout en gardant l’âme de la boucherie GARNIER, Thierry VEYRENCHE a repris la méthode des anciens
                        et propose des viandes issues d’élevages des alentours où il se rend lui-même pour sélectionner
                        les meilleures bêtes.<br/>
